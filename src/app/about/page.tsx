    ...
    <div>
      <section className="min-h-[40vh] bg-gradient-to-br from-slate-100 to-slate-50 dark:from-slate-950 dark:to-slate-900 flex items-center justify-center py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center animate-fade-in">
          ...
          <p className="text-xl text-gray-700 dark:text-gray-300 mb-8">{t.heroSub}</p>
          <ResumeDownload />
        </div>
      </section>
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="prose dark:prose-invert max-w-none animate-slide-up">
          ...
          <p className="text-lg text-gray-700 dark:text-gray-300 mb-6 leading-relaxed">{t.summary1}</p>
          <p className="text-lg text-gray-700 dark:text-gray-300 mb-6 leading-relaxed">{t.summary2}</p>
